...
local success, Window = pcall(function()
    return WindUI:CreateWindow({
        Title = "Grow a Garden Script Hub V1.4 - discord.gg/BgESyY5vQr",
        Icon = "flower-2",
        Author = "by Vofflann",
        Folder = "",
        Size = windowSize,
...
local seeds = {
    "Sugar Apple", "Loquat", "Feijoa", "Kiwi", "Bell Pepper", "Prickly Pear", "Carrot", "Tomato", "Strawberry", "Blueberry", "Corn", "Pumpkin", "Watermelon", "Apple", "Coconut",
